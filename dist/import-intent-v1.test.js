...
import { DATABOX_IMPORT_RESOURCE, MDP_CONTRACT_VERSION, MDP_MAX_QR_URL_LENGTH, MEOS_DO_HOST, buildImportIntentV1, buildMeosLink, decodeImportIntentV1, decodeMeosLink, encodeImportIntentV1, parseWidgetAttribution, selectImportTier, } from "./import-intent-v1.js";
...
describe("encodeImportIntentV1 / decodeImportIntentV1 title flags", () => {
    ...
    it("omits default wire keys (ft when true, rt when false)", () => {
        const encoded = encodeImportIntentV1(buildImportIntentV1({ u: "https://example.com/article" }));
...
describe("buildMeosLink", () => {
    it("builds canonical meos.do URL", () => {
        const url = buildMeosLink(buildImportIntentV1({ u: "https://example.com/article" }));
        expect(url).toBe(`https://${MEOS_DO_HOST}/${DATABOX_IMPORT_RESOURCE}:${encodeImportIntentV1(buildImportIntentV1({ u: "https://example.com/article" }))}`);
    });
...
//# sourceMappingURL=import-intent-v1.test.js.map