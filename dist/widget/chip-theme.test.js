...
import { resolveChipCustomisation, resolveChipCustomisationVars, resolveChipLabel, SAVE_CHIP_PRESETS, } from "./chip-theme.js";
...
describe("resolveChipCustomisation", () => {
    ...
    it("returns preset alone", () => {
        expect(resolveChipCustomisation(undefined, "default")).toEqual(SAVE_CHIP_PRESETS.default);
    });
});
...
//# sourceMappingURL=chip-theme.test.js.map