...
/** Normalised viewBox for the charcoal nostroke logo path. */
export const MEOS_SAVE_ICON_VIEWBOX = "0 0 28 31"

/** Logo path from meos-workshop/shared/branding/meos-logo-charcoal-nostroke.svg */
...
export function buildSaveIconSvg(className: string): string {
  return `<svg class="${className}" viewBox="${MEOS_SAVE_ICON_VIEWBOX}" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><g transform="${LOGO_TRANSFORM}"><path d="${MEOS_LOGO_PATH}" fill="currentColor"/></g></svg>`
}
